...
public class RqTest {
    ...
    @Test
    @DisplayName(value = "명령: tnwjd?id=1 일때, rq.getActionName() - 수정")
    void t2(){
    ...
    @Test
    @DisplayName(value = "명령: 목록?keword=자바?keywordType=title 일때, rq.getParam(\"keywordType\") -> \"title\"")
    void t5(){
    ...
    @Test
    @DisplayName(value = "명령: 목록?keword=자바?keywordType=title&page=1 일때, rq.getParam(\"keywordType\") -> \"title\"")
    void t8(){
